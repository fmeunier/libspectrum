...
rzx_iterator_delete_removes_block_from_list( void )
{
  ...
  if( libspectrum_rzx_start_input( rzx, 0 ) ) {
    fprintf( stderr, "%s: rzx_iterator_delete_removes_block_from_list: start_input failed\n",
             progname );
    goto done;
  }
...
rzx_rollback_returns_last_snap_and_removes_trailing_blocks( void )
{
  ...
  if( libspectrum_rzx_start_input( rzx, 0 ) ) {
    fprintf( stderr, "%s: rzx_rollback_returns_last_snap_and_removes_trailing_blocks: start_input failed\n",
             progname );
    goto done;
  }
...
rzx_rollback_to_returns_nth_snap( void )
{
  ...
  if( libspectrum_rzx_start_input( rzx, 0 ) ) {
    fprintf( stderr, "%s: rzx_rollback_to_returns_nth_snap: start_input(1) failed\n", progname );
    libspectrum_snap_free( snap2 );
    goto done;
  }
  libspectrum_rzx_stop_input( rzx );
  ...
  if( libspectrum_rzx_start_input( rzx, 0 ) ) {
    fprintf( stderr, "%s: rzx_rollback_to_returns_nth_snap: start_input(2) failed\n", progname );
    goto done;
  }
  libspectrum_rzx_stop_input( rzx );
