...
test_return_t
tape_block_count_returns_correct_count( void )
{
  /* libspectrum_tape_block_count: returns correct block count */
  libspectrum_tape *tape = libspectrum_tape_alloc();
  libspectrum_tape_block *b1, *b2, *b3;
  test_return_t r = TEST_FAIL;
  ...
  if( libspectrum_tape_block_count( tape ) != 0 ) {
    fprintf( stderr, "%s: tape_block_count_returns_correct_count: "
             "expected 0 for empty tape, got %lu\n", progname,
             (unsigned long)libspectrum_tape_block_count( tape ) );
    goto done;
  }
  ...
  libspectrum_tape_append_block( tape, b1 );
  if( libspectrum_tape_block_count( tape ) != 1 ) {
    fprintf( stderr, "%s: tape_block_count_returns_correct_count: "
  ...
  if( libspectrum_tape_block_count( tape ) != 3 ) {
    fprintf( stderr, "%s: tape_block_count_returns_correct_count: "
